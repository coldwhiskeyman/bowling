...
parser = argparse.ArgumentParser(description='Bowling tournament script')

parser.add_argument('--input', action="store", dest="input_file")
parser.add_argument('--output', action="store", dest="output_file")
result = parser.parse_args()

tournament = TournamentParser(result.input_file, result.output_file)
tournament.read_file()
